...
from robot_configs.value_robot_new import robot_epoch as robot_epoch1
from robot_configs.value_robot_new_2 import robot_epoch as robot_epoch2
from robot_configs.value_robot_new_3 import robot_epoch as robot_epoch3
import pickle
...
plt.title('Percentage of tiles cleaned with gamma=0.5 and full cleaning.')
plt.xlabel('% cleaned')
plt.ylabel('count')
...
for x,y in zip(res_cl3_x,res_cl3[0]):
    plt.text(x,y,y, ha='center', va='bottom', fontsize=10)
plt.legend(['threshold=2.1', 'threshold=50', 'threshold=150'])
plt.show()
...
plt.title('Efficiency of robot with gamma=0.5 and full cleaning.')
plt.xlabel('Efficiency %')
plt.ylabel('count')
